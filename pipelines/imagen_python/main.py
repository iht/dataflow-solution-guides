...
from imagen_pipeline.options import MyPipelineOptions
from imagen_pipeline.pipeline import create_pipeline
...
if __name__ == "__main__":
  ...
  dataflow_options.job_name = f"imagen-inference-pipeline-{now_epoch_ms}"
